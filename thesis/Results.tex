...
\begin{figure}[ht]
\centering
\includegraphics[scale=.333333]{images/results_flocking/fmacc-kNN.png}
\includegraphics[scale=.333333]{images/results_flocking/fmacc-LOESS.png}
\caption{...}
...
\begin{figure}[ht]
\centering
\includegraphics[scale=.5]{images/results_flocking/fmtraining.png}
\caption{...}
\label{fig:flockfmtraining}
\end{figure}

Figure \ref{fig:flockfmtraining}.
...
\begin{figure}[ht]
\centering
\includegraphics[scale=.5]{images/results_flocking/fmquery.png}
\caption{...}
\label{fig:flockfmquery}
\end{figure}

Figure \ref{fig:flockfmquery}.
