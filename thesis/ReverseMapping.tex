...
\quote{What is the average of the values for the $k$ nearest point to configuration vector $\mathbf c$?}
The inverse of this statement is:
\quote{What space covered by $k$ neighboring points would produce the average $p$?}
